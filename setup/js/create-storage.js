...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var browser, context, page, storagePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                page = _a.sent();
                return [4 /*yield*/, page.goto('https://qauto.forstudy.space/')];
            case 4:
                _a.sent();
                return [4 /*yield*/, page.click('text=Sign In')];
            case 5:
                _a.sent();
                return [4 /*yield*/, page.fill('#signinEmail', 'guest_auto@example.com')];
            case 6:
                _a.sent();
                return [4 /*yield*/, page.fill('#signinPassword', 'Welcome2qauto')];
            case 7:
                _a.sent();
                return [4 /*yield*/, page.getByRole('button', { name: 'Login' }).click()];
            case 8:
                _a.sent();
                return [4 /*yield*/, page.waitForSelector('#userNavDropdown', { timeout: 60000 })];
            case 9:
                _a.sent();
                storagePath = path_1.default.resolve(__dirname, '../state/user.json');
